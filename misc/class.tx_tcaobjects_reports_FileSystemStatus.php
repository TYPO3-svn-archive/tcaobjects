 ...
 * @package		TYPO3
 * @subpackage	tx_tcaobjects
 */
class tx_tcaobjects_reports_FileSystemStatus implements tx_reports_StatusProvider {

	protected $reportList = 'FileSystem';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tcaobjects/misc/class.tx_tcaobjects_reports_FileSystemStatus.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tcaobjects/misc/class.tx_tcaobjects_reports_FileSystemStatus.php']);
}
