 ...
 * @since 2010-04-21
 */
class tx_tcaobjects_reports_tca implements tx_reports_StatusProvider {
	...
	public function getStatus() {
		...
		foreach ($GLOBALS['TCA'] as $table => $conf) {
			...
			// check if all fields used in all pallettes are valid
			// check if all fields in the pallette are used max once
			// check if all fields used in all types are valid 
			// check if all fields in the type are used max once (include check if the field is in a pallette)
