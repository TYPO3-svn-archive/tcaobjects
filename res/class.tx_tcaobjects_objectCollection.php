...
class tx_tcaobjects_objectCollection extends tx_pttools_objectCollection implements tx_tcaobjects_iPageable {
	...
	public function first() {
		tx_pttools_assert::isFalse($this->isEmpty(), array('message' => 'Unable to get the first element because the collection is empty.'));
	...
	public function last() {
		tx_pttools_assert::isFalse($this->isEmpty(), array('message' => 'Unable to get the last element because the collection is empty.'));
